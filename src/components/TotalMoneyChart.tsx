    ...
    <Card className="border-b py-4 shadow-none">
      <CardHeader className="flex items-center gap-2 space-y-0 p-0 px-4 sm:flex-row">
        <div className="grid flex-1 gap-1">
          ...
          <CardDescription>Showing total money for this year</CardDescription>
        </div>
          ...
          <AreaChart data={filteredData}>
            <defs>
              ...
              <linearGradient id="fillMobile" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#117" stopOpacity={0.8} />
                <stop offset="95%" stopColor="#117" stopOpacity={0.1} />
              </linearGradient>
            </defs>
